...
export default function Season3Covers({ comics }: { comics: Comic[] }) {
    ...
    <div className={styles.archiveContainer}>
      ...
      <div className={styles.aboutSeasonContainer}>
        <div className={styles.aboutSeason}>
          <p>The third season of Herb was planned to be the longest running season but was halted suddenly. The season only has eight episodes.</p>
        </div>
      </div>
    </div>
  );
