...
export default function Season1Covers({ comics }: { comics: Comic[] }) {
  ...
  useEffect(() => {
    // Scroll to the beginning of the panels when a new episode is selected
    ...
    <div className={styles.archiveContainer}>
      {selected && (
        <div className={styles.selectedComic}>
          ...
          <div
            className={styles.panelsRowS1}
            ref={panelsRef} // Attach the ref to the panels container
          >
      ...
      <div className={styles.aboutSeasonContainer}>
        <div className={styles.aboutSeason}>
          <p>Herb’s first season was written in early 2020 and features medium-length stories. In total, nine episodes were made.</p>
        </div>
      </div>
    </div>
  );
